...
public class ExceptionHandling implements ErrorController{
    ...
    public static final String INTERNAL_SERVER_ERROR_MSG = "An error occurred while processing this request";
    ...
    public ResponseEntity<HttpResponse> accountDisabledException(EmailNotFoundException exception){
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
...
/*    @ExceptionHandler(NoHandlerFoundException.class)
    ...
    public ResponseEntity<HttpResponse> internalServerErrorException(IOException exception) {
        LOGGER.error(exception.getMessage());
